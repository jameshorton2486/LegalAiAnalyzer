  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold text-neutral-800">Case Transcripts</h2>
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto">
          {filteredTranscripts.length === 0 ? (
            <div className="py-8 text-center">
              <p className="text-neutral-500">No transcripts found. Upload a transcript to get started.</p>
            </div>
          ) : (
            <table className="min-w-full divide-y divide-neutral-300">
              <thead>
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wider">Witness</th>
                  ...
                  <tr key={transcript.id} className="hover:bg-neutral-100">
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="text-sm font-medium text-neutral-800">{transcript.title}</div>
                          <div className="text-xs text-neutral-500">{transcript.pages} pages</div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-neutral-700">
                      {transcript.date ? format(new Date(transcript.date), 'MMM d, yyyy') : 'N/A'}
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <Link href={`/transcripts/${transcript.id}`}>
                        <a className="text-primary-dark hover:text-primary-light mr-3">View</a>
                      </Link>

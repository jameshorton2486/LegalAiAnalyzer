  ...
  return (
    <aside className="w-full md:w-64 bg-white border-r border-neutral-300 md:h-[calc(100vh-57px)] md:sticky md:top-[57px]">
      <nav className="p-4">
        ...
        <div className="mt-8">
          <h3 className="px-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Recent Cases</h3>
          <div className="mt-2 space-y-1">
            ...
            {recentCases.length === 0 && (
              <p className="text-sm text-neutral-500 px-3 py-2">No recent cases</p>
            )}
          </div>
        </div>
      </nav>
